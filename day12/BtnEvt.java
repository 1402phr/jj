...
public class BtnEvt implements ActionListener {
	Ex01 main;
	JFileChooser fc = new JFileChooser("C:/Users/user/git/456/456/kingdom_me/src/day12");
	public BtnEvt() {}
	...
	public void doSave() {
		...
		try {
			...
			JOptionPane.showMessageDialog(main.fr, file.getName() + " ] 파일저장에 성공했습니다");
		}catch(Exception e) {
			e.printStackTrace();
		}finally {
			try {
